...
const Sidebar = () =>{
    ...
    return (
        <div className = 'w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex'>
            <div className = 'bg-[#121212] h-[15%] rounded-sm flex flex-col justify-around'>
            ...
            <div className = 'bg-[#121212] h-[85%] rounded-sm'>
                ...
                <div className = 'p-4 bg-[#242424] m-2 rounded-sm font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt4'>
